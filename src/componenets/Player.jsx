...
const Player = () => {
  ...
  return (
    ...
    flex justify-between items-center text-white px-4'>
        ...
        <div className='flex flex-col items-center gap-1 m-auto'>
            <div className='flex gap-4 '>
                ...
                src={assets.shuffle_icon} alt=''></img>
                <img onClick={previous} className ='w-4 cursor-pointer'
                src={assets.prev_icon} alt=''></img>
                {playStatus 
                ? <img onClick={pause} className ='w-4 cursor-pointer'
                src={assets.pause_icon} alt=''></img>
                :<img onClick={play} className ='w-4 cursor-pointer'
                src={assets.play_icon} alt=''></img>
                }
                <img onClick={next} className ='w-4 cursor-pointer'
                src={assets.next_icon} alt=''></img>
                <img className ='w-4 cursor-pointer'
                src={assets.loop_icon} alt=''></img>
            </div>
            ...
            <div className='flex items-center gap-5 '>
                ...
                className='w-[60vw] max-w-[500px]
                 bg-gray-300 rounded-full cursor-pointer' >
                    <hr ref={seekBar} className='h-1 border-none w-0
                     bg-green-800 rounded-full'></hr>
                </div>
